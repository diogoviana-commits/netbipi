...
export const env = {
  ...
  DATABASE_URL:
    ...
    'postgresql://netbipi:netbipi123@localhost:5432/netbipi',
  JWT_SECRET:
    process.env.JWT_SECRET || 'netbipi-super-secret-key-change-in-production',
  ...
  ZABBIX_WEBHOOK_SECRET:
    process.env.ZABBIX_WEBHOOK_SECRET || 'netbipi-webhook-secret-2024',
